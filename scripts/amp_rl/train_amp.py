...
parser.add_argument("--wandb_username", type=str, default=None, help="Wandb username.")
...
# if wandb is enabled, initialize it set the environment variable
if args_cli.wandb_username:
    os.environ["WANDB_USERNAME"] = args_cli.wandb_username
    print(f"[INFO] Setting WANDB_USERNAME to: {args_cli.wandb_username}")
